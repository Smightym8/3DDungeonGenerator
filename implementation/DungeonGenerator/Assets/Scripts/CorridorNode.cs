...
public class CorridorNode : Node
{
    ...
    private void ProcessRoomInRelationRightOrLeft(Node structure1, Node structure2)
    {
        ...
        rightStructure = possibleNeighboursInRightStructureList.Count <= 0 ? structure2 : possibleNeighboursInRightStructureList[0];
    ...
    private void ProcessRoomInRelationUpOrDown(Node structure1, Node structure2)
    {
        ...
        topStructure = possibleNeighboursInTopStructure.Count == 0 ? structure2 : possibleNeighboursInTopStructure[0];
        ...
        TopRightAreaCorner = new Vector2Int(x + this._corridorWidth, topStructure.BottomLeftAreaCorner.y);
    }
    ...
    private RelativePosition CheckPositionStructure2AgainstStructure1()
    {
        ...
        if (angle is < 45 and >= 0 || angle is > -45 and < 0)
        {
